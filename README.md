...
This library is maintained for [gosf-socketio](https://github.com/ambelovsky/gosf-socketio), the GoLang SocketIO Framework.
...
```sh
go get -u github.com/ambelovsky/gosf-socketio-socketio
```
